...
We will use [megahit](https://github.com/voutcn/megahit) for the assembly in this tutorial, but there are [many other assembly](../SequenceAssembly) algorithms out there. Megahit is fast and does not consume a lot of memory.
...
minimap2 -x sr -d results/assemblies/final.contigs.fa results/mapping/contigs.mmi
```
